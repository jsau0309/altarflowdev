...
export function ManualDonationDialog({ isOpen, onClose, onSuccess }: ManualDonationDialogProps) {
    ...
    if (isOpen) {
      ...
      const fetchDonors = async () => {
        ...
        try {
          ...
          logger.error('Failed to fetch donors for manual donation:', { operation: 'ui.error' }, error instanceof Error ? error : new Error(String(error)));
          setDonors([]);
      ...
      const fetchDonationTypes = async () => {
        ...
        try {
          ...
          logger.error('Failed to fetch donation types:', { operation: 'ui.error' }, error instanceof Error ? error : new Error(String(error)));
          setDonationTypes([]);
      ...
      const fetchPaymentMethods = async () => {
        ...
        try {
          ...
          logger.error('Failed to fetch payment methods:', { operation: 'ui.error' }, error instanceof Error ? error : new Error(String(error)));
          setPaymentMethods([]);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      logger.error('Failed to save manual donation:', { operation: 'ui.error' }, error instanceof Error ? error : new Error(String(error)));
